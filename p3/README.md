...
<p align="center">
<img src="results/s1.png" width="500"/>
</p>
...
Here is a snippet of the source code from the QuadControl.cpp file, included as part of the project's final solution.
```cpp
    ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
  ...
  /////////////////////////////// END STUDENT CODE ////////////////////////////
```
 - Accordingly, the `BodyRateControl()` function and subsequent functions are implemented, providing a successful solution to the tasks.
 - By adjusting `kpPQR` in `QuadControlParams.txt`, I obtained the following results from the simulator.
...
<p align="center">
<img src="results/s2.png" width="500"/>
</p>
...
<p align="center">
<img src="results/s3.png" width="500"/>
</p>
...
<p align="center">
<img src="results/s4.png" width="500"/>
</p>
...
<p align="center">
<img src="results/s5.png" width="500"/>
</p>
...
## Authors ##
Tommy NGUYEN. Thanks to Fotokite for the initial development of the project code and simulator.