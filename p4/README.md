...
In the controls project, the simulator initially operated under the assumption of ideal sensors, meaning that none of the sensors were affected by noise. To introduce more realism to the scenario and develop an estimator, the next step is to incorporate noise into the quad's sensors. This phase involves gathering simulated sensor data with added noise and estimating the standard deviation of the quad's sensor readings.

After running the simulator with the 06_NoisySensors scenario, the following results were obtained:
...
Nhut NGUYEN. Thanks to Fotokite for the initial development of the project code and simulator.